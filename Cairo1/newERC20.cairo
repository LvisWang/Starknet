...
mod ERC20 {
    ...
    // new constructor, input name/symbol/decimals/supply/recipient and getem later in view functions
    #[constructor]
    fn constructor(
    ...
    // new view functions, get all data above
    #[view]
    fn get_name() -> felt {
        name::read()
    }
    ...
    // new external functions transfer/transfer_from/approve... 
    #[external]
